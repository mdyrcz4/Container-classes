...
int main(void)
{
    ...
    Vector<int> a, b;
    Vector<int>c;
    Container<int> *cptr = &a;
    Iterator<int> iter1(&a), iter2(&b), iter3(cptr);
    ...
    //Test wyjatku dla kontenera Vector - proba odczytania elementu o nieistniejacym indexie
    c.append(1);
    c.append(2);
    c.clear();
    try
